...
**     Date/Time   : 2015-12-13, 23:10, # CodeGen: 13
**     Abstract    :
...
#define LEDB_ClrVal()    LEDpin4_ClrVal() /* put the pin on low level */
#define LEDB_SetVal()    LEDpin4_SetVal() /* put the pin on high level */
#define LEDB_SetInput()  LEDpin4_SetInput() /* use the pin as input pin */
#define LEDB_SetOutput() LEDpin4_SetOutput() /* use the pin as output pin */

#define LEDB_PARSE_COMMAND_ENABLED  0 /* set to 1 if method ParseCommand() is present, 0 otherwise */


#define LEDB_On() LEDpin4_ClrVal()
/*
** ===================================================================
...
#define LEDB_Off() LEDpin4_SetVal()
/*
** ===================================================================
...
#define LEDB_Neg() LEDpin4_NegVal()
/*
** ===================================================================
...
#define LEDB_Get() (!(LEDpin4_GetVal()))
/*
** ===================================================================
