...
#define LEDG_ClrVal()    LEDpin1_ClrVal() /* put the pin on low level */
#define LEDG_SetVal()    LEDpin1_SetVal() /* put the pin on high level */
#define LEDG_SetInput()  LEDpin1_SetInput() /* use the pin as input pin */
#define LEDG_SetOutput() LEDpin1_SetOutput() /* use the pin as output pin */

#define LEDG_PARSE_COMMAND_ENABLED  0 /* set to 1 if method ParseCommand() is present, 0 otherwise */


#define LEDG_On() LEDpin1_ClrVal()
/*
** ===================================================================
...
#define LEDG_Off() LEDpin1_SetVal()
/*
** ===================================================================
...
#define LEDG_Neg() LEDpin1_NegVal()
/*
** ===================================================================
...
#define LEDG_Get() (!(LEDpin1_GetVal()))
/*
** ===================================================================
