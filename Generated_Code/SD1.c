...
**     Date/Time   : 2015-12-11, 18:03, # CodeGen: 2
**     Abstract    :
...
#define SD1_SPI_Enable()                   (void)SM1_Enable(SM1_DeviceData)
#define SD1_SPI_Disable()                  (void)SM1_Disable(SM1_DeviceData)
#define SD1_SPI_SetSlowMode()              (void)SM1_SelectConfiguration(SM1_DeviceData, 0, 0) /* max 400kbps */
#define SD1_SPI_SetFastMode()              (void)SM1_SelectConfiguration(SM1_DeviceData, 1, 1) /* max 12Mbps */
